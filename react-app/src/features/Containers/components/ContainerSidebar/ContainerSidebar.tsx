...
import type { ContainerInfo, ContainerReview } from '../../../../types.ts';
import { getContainerReviews, createContainerReview } from '../../../../api.ts';
import { getWasteTypeName, getWasteTypeColor } from '../../../../types.ts';
import '../Sidebar.css';
    ...
    return (
        <div className="sidebar">
            ...
            <div className="sidebar__content">
                ...
                <div className="sidebar__section">
                    <h3 className="sidebar__section-title">Отзывы {reviews.length > 0 && `(${reviews.length})`}</h3>
