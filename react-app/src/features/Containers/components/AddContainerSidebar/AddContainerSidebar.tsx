...
import type { CreateContainerRequest } from '../../../../types.ts';
import { WasteType, getWasteTypeName } from '../../../../types.ts';
import '../Sidebar.css';
                            ...
                            {allWasteTypes.map((type) => (
                                <label key={type} className="waste-type-item">
                                    <input
                                        ...
                                        disabled={submitting}
                                    />
                                    <span>{getWasteTypeName(type as import('../../../../types.ts').WasteType)}</span>
                                </label>
                            ))}
                        </div>
                    </div>
